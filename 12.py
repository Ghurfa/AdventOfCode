...
def main():
    ...
    while True:
        ...
        curr_height = 0 if curr_char == 'S' else (25 if curr_char == 'E' else ord(curr_char) - ord('a'))
        for neighbor in neighbors(curr, bounds):
            neighbor_char = grid[neighbor[1]][neighbor[0]]
            neighbor_height = 0 if neighbor_char == 'S' else (25 if neighbor_char == 'E' else ord(neighbor_char) - ord('a'))
